            ...
            "providers": {
                "openai": {
                    ...
                    "models": [
                        ...
                        {"name": "gpt-5.5", "tier": "high"},
                    ],
                }
            },
            "upgrade_chain": ["glm-4-flash", "glm-4", "glm-5", "gpt-5.5"],
        }

        assert get_upgrade_path("glm-4", config) == ["glm-4", "glm-5", "gpt-5.5"]
        assert get_upgrade_path("custom-model", config) == ["glm-4", "glm-5", "gpt-5.5"]
