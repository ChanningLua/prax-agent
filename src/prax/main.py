    ...
    *,
    ...
    async def _executor(description: str, prompt: str, subagent_type: str, max_turns: int | None, load_skills: list | None = None) -> str:
        ...
        try:
            ...
            elif subagent_type.lower() == "plan" and get_model_entry("claude-sonnet-4-8", models_config):
                model_hint = "claude-sonnet-4-8"
            task_prompt = (
...
def _bootstrap_session(
    *,
    ...
    if model_override:
        ...
        model_name = classifier.select_model(task, models_config.get("default_model", "gpt-5.5"))
